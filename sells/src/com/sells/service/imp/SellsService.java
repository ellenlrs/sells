...
public interface SellsService {
   ...
   * @throws Exception
   */
  public LoginData findLoginDataByLoginId(String loginId,String loginTp,String passwd,String remoteIp) throws Exception ;
...
//  public void findLoginDataSearch(String loginId) throws Exception ;
   ...
   * @return
   */
  public Collection<Orders> findOrdersSearch(OrdersSearch search,PageControl control ) ;
