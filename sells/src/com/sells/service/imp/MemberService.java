...
public interface MemberService {
   ...
   * @throws Exception
   */
  public Member findMember(String email,String sellsNo,String password) throws Exception ;
   ...
   * @throws Exception
   */
  public Member findMemberPassword(String email,String sellsNo,String name,String birthday) throws Exception ;
