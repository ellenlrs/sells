 ...
 */
public class CarCode6Action extends Action {
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      if (sells == null ) {
        ...
        sb.append("<a href='").append(admin.getHomepage()).append("/Sells/shopcar.do?func=VIEW&formtp=free&sells=").append(sells.getSellsNo()).append("' ");
