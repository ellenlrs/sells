...
public class OrderCarAction extends Action {
  private final Log log = LogFactory.getLog(OrderCarAction.class);
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      if (sells == null) {
        ...
        sb.append("請在48小時內完付款，請到<a href=\"").append(admin.getHomepage())
            .append("/Sells/help.jsp\">問題反應區</a>通知站長，將會為您開啟延長服務。  </p>");
        sb.append("<p>匯款方式：<br />");
