...
import com.sells.common.util.UtilString;
...
public class MemOrderMessageUpdateAction extends Action {
  ...
  private Log log = LogFactory.getLog(MemOrderMessageUpdateAction.class);
      ...
      String memNm = ObjectUtils.toString(session.getAttribute("icMemNm"));
        if (sellsNo.equals("")
          ...
          if (vo != null && StringUtils.isNotBlank(vo.getOrderNo())) {
            ...
            sb.append("  <tr>\n");
            sb.append("    <td colspan=\"2\" align=\"center\" bgcolor=\"#F5F5F5\" ><font size=\"2\">客戶線上留言通知</font></td>\n");
            sb.append("  </tr>\n");
            sb.append("  <tr>\n");
            ...
            mailBean.setSubject(sells.getStoreNm()+ " - "+vo.getOrderNo()+" 客戶留言通知");
