 ...
 */
public class SellOrderDetailAction extends Action {
  private SellsService sellsService;
  private Log log = LogFactory.getLog(SellOrderDetailAction.class);
  ...
  public void setServlet(ActionServlet actionServlet) {
    ...
    try {
      ...
      if ( vo != null && StringUtils.isNotBlank(vo.getOrderNo())){
        ...
        request.setAttribute("msg",StringUtils.defaultString(request.getParameter("msg")));
