...
public class SellOrderMessageUpdateAction extends Action {
  ...
  private final Log log = LogFactory.getLog(SellOrderMessageUpdateAction.class);
    ...
    try {
      ...
      if (vo != null && StringUtils.isNotBlank(vo.getOrderNo())) {
        ...
        sb
            ...
            .append(sells.getStoreNm()).append("訂單留言通知</font></td>\n");
        sb.append("  </tr>\n");
        sb.append("  <tr>\n");
        sb
        ...
        sb.append("    <td bgcolor=\"#F5F5F5\" ><font size=\"2\">").append(
            DateUtils
                .getTodayAddDays(vom.getMessDt(), 0, "yyyy/MM/dd HH:mm:ss"))
            .append("</font></td>\n");
        sb.append("  </tr>\n");
        sb.append("</table>\n");
        sb.append("</body>\n");
