...
public class QrpwdMemberAction extends Action {
  ...
  private Log log = LogFactory.getLog(QrpwdMemberAction.class);
...
//    2.查詢會員
      Member vo = memberService.findMemberPassword(request.getParameter("email"), request.getParameter("sells"),request.getParameter("name"), request.getParameter("birthDt"));
      log.info("aa"); 
      ...
      if (vo == null ) {
        ...
        sb.append("<title>").append(sells.getSellsNm()).append(" 會員密碼查詢</title>");
        sb.append("</head>");
        sb.append("");
        sb.append("<body>");
        sb.append("<p><br />");
