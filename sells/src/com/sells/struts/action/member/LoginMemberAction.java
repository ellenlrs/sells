 ...
 */
public class LoginMemberAction extends Action {
  private SellsService sellsService ;
  private MemberService memberService ;
  private Log log = LogFactory.getLog(LoginMemberAction.class);
...
//    2.查詢會員
      ...
      vo = memberService.findMember(request.getParameter("email"), request.getParameter("sells"), request.getParameter("password"));
      if (vo == null ) {
        ...
        log.info("getSellsId:"+session.getId() + ",setSellsNO:"+sellsNo+",setMemNo:"+vo.getMemberNo());
        request.setAttribute("sells", sells);
        return mapping.findForward("success");
      }
    } catch (Exception e ) {
      log.info( e.toString());
      errors.add("errMsg", new ActionError("alert.Error","登入失敗，"+e.getMessage()));
      saveErrors(request, errors);
      return mapping.findForward("memError");
    }
	}
