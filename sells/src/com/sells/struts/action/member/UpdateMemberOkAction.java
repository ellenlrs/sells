 ...
 */
public class UpdateMemberOkAction extends Action {
  private SellsService sellsService ;
  private Log log = LogFactory.getLog(UpdateMemberOkAction.class);
  ...
  public void setServlet(ActionServlet actionServlet) {
    ...
    try {
      ...
      log.info("getSellsNO:"+sellsNo+";getMemNo:"+memNo);
