...
/**
 * MyEclipse Struts Creation date: 09-06-2007
 * 
 * XDoclet definition:
 * 
 * @struts.action validate="true"
 */
public class MemberQuery3Action extends Action {
  private MemberService memberService;
  private Log log = LogFactory.getLog(MemberQuery3Action.class);
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      search.setStatus("Y");
      search.setBirthDt(request.getParameter("birM"));
      if (StringUtils.defaultString(request.getParameter("search")).equals("")) {
        ...
        request.setAttribute("birM", request.getParameter("birM"));
