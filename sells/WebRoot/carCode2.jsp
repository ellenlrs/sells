...
<table width="615" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td ><table width="600" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
      <tbody>
        <tr>
          <td width="100%" align="left" class="style1">此功能不支援Blog（Blogger 及 Sina Blog 新浪網除外）或相簿，支援一般網頁，包含免費網頁空間<br>
        ...
        <table width="600" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
          <tbody>
            <tr>
              ...
              <td align="center" bgcolor="#CCCCCC"><b class="style3">多重商品規格Html產生器</b><b><a href="carCode2.jsp" class="t1"></a></b> </td>
      ...
      <table width="600" border="0" align="center" cellpadding="10" cellspacing="1" bgcolor="#CCCCCC">
          <tbody>
            <tr>
              <td colspan="3" bgcolor="#ffffff"><form method="post" name="cart" action="carCode2.do#code" onSubmit="return check(this);" >
                <span class="style5">1：商品編號(必填)︰
                  <input type="text" name="itemNo" size="20" value="${itemNo}">
                  <br />
                  2：商品名稱(必填)︰
                  <input type="text" name="itemNm" size="60" value="${itemNm}">
                  <br />
                3：規格</span><span class="t1"><br>
                    </span><span class="style1">如果您的商品有多種規格，例如顏色或尺寸，您可以用規格1和規格2來組合購物車程式碼<br>
                      但不同規格商品訂購金額需一樣</span><span class="t1"><br>
                      <br>
                      </span><span class="style3"><strong>例如︰耐衝擊電腦內袋-有12寸、14寸、15寸 三種尺寸以及有黑色、灰色、藍色 三種顏色<br>
                      您可以在商品名稱填【耐衝擊電腦內袋】商品規格1和商品名稱2請依照下面範例填寫</strong></span><span class="t1"><br>
                        <br />
                        </span><span class="style5">商品規格1(可不填)︰</span>
                  <table width="100%" border="0" cellpadding="2">
                    <tr>
                      <td width="50%" ><textarea rows="6" name="spec1" cols="40">${spec1}</textarea></td>
                      <td width="50%" valign="top" ><span class="style5">填寫範例(請用</span><span class="style1">;</span><span class="style5">分隔)</span><br>
                      <font class="style3">12寸;14寸;15寸</font></td>
                    </tr>
                </table>
                <span class="style5">商品規格2(可不填)︰</span>
                  <table width="100%" border="0" cellpadding="2">
                    <tr>
                      <td width="50%" ><textarea rows="6" name="spec2" cols="40">${spec2}</textarea></td>
                      <td width="50%" valign="top" ><span class="style5">填寫範例(請用</span><span class="style1">;</span><span class="style5">分隔)</span><br>
                      <font class="style3">黑色;灰色;藍色</font><br></td>
                    </tr>
                </table>
<span class="style5">4：商品價格(必填)︰$
                  <input type="text" name="price" size="10" value="${price}">
                  元(請填數字，不可使用逗點)<br />
                  <br />
                  5：商品說明(可不填)︰</span><br />
                  <textarea rows="6" name="desc" cols="70">${desc}</textarea>
                  <br />
                  <br />
            <span class="style5">6：顯示方式(可選文字連結或圖片連結)<br />
                </span>
            ...
            <span class="style5">
                  ...
                  同視窗&nbsp;&nbsp;&nbsp; <input type="radio" value="_blank" name="target" ${requestScope.target == '_blank' ?'checked':''}>
                跳出新視窗</span><br />
                &nbsp;
                    ...
                    <table border="0" cellspacing="1" width="100%" bgcolor="#CCCCCC" cellpadding="5">
                      ...
                      <tr>
                        <td  bgcolor="#FFFFFF"><textarea id="textarea" name="textarea" onClick="this.focus(); this.select();" cols="70" rows="10">${car}</textarea>
                          <br>
                        <input type="button" name="Submit" onClick='document.getElementById("textarea").createTextRange().execCommand("Copy");' value="複製">                        </td></tr>
                    </table>
              </c:if></td>
            </tr>
          </tbody>
