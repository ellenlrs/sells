...
<body><center><form name="member" action="loginMember.do" method="Post" onSubmit="return sendForm(this);">
...
<table width="670" border="0" align="center" cellspacing="1" class="tb1">
  <tr class="tb2">
          <td height="28" colspan="2" align="center" bgcolor=#FFFFFF class="style1">您已離線太久請重新登入!</td>
      </tr>
        <tr class="tb2">
...
<input type="hidden" name="func" value="QRPWD"></td>
        </tr>
    </table>
</form><%@ include file="footer.jsp"%>
</center>
</body>
</html><script src="./global/global.js" type="text/javascript"></script>
<script>
<!--
