...
<table width="670" border="0" align="center" cellspacing="1" class="tb1">
        ...
        <tr class="tb2">
          <td height="28" align="center" colspan=4 bgcolor="#FFFFFF">
          <input name="b122" value="我是 ${sessionScope.icMemNm}；直接登入" type="button" onclick="sendSessionForm(this.form)" class="button"></td>
        </tr>
		    <tr>
          <td height="28" colspan=4 align="center" bgcolor=#FFFFFF>
            <input name="b122" value="確認送出" type="submit" class="button">
            <input name="b123" value="重填" type="reset" class="button">
            <input name="b123" value="我要登出" type="button" class="button">
...
function sendSessionForm(formObj){
  formObj.action = 'loginMemberSess.do' ;
  formObj.submit();
}
function logout(formObj){
  formObj.action = 'logoutMember.do' ;
  formObj.submit();
}
-->
</script>