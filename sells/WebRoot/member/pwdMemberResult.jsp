...
<table width="670" border="0" align="center" cellspacing="1" class="tb1">
     <c:if test="${requestScope.Status == '3'}">  
        <tr class="tb2">
          <td height="28" align="center" bgcolor="#FFFFFF"><p class="style1">您的密碼已寄到您的信箱中</p>
          </td>
       </tr></c:if>
        <c:if test="${requestScope.Status == '1' || requestScope.Status == '2' }">  
        <tr class="tb2">
          <td align="center" bgcolor="#FFFFFF" class="style1" >很抱歉，查無此人，您可透過聯絡賣場主人，請賣場主人幫忙查詢:${requestScope.Status}</td>
          </tr></c:if>
		<tr>
          <td height="28" colspan=3 align="center" bgcolor=#FFFFFF>
            <input name="b123" onClick="goHome();" value="返回賣場" type="button" class="button">
<input name="b1222" value="聯絡賣場主人" type="submit" class="button"></td>
        </tr>
  </table>
