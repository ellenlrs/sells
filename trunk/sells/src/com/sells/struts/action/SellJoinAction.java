 ...
 * 
 * XDoclet definition:
 * @struts.action path="/SellsJoin" name="sellsForm" input="/form/sells.jsp" scope="request" validate="true"
 */
public class SellJoinAction extends Action {
  private SellsService sellsService ;
  private Log log = LogFactory.getLog(SellJoinAction.class);
  ...
  public void setServlet(ActionServlet actionServlet) {
    ...
    try {
      ...
      sb.append("<title>歡迎  ").append(sellsvo.getSellsNm()).append(" 加入</title>");
      sb.append("</head>");
      sb.append("");
      sb.append("<body>");
      sb.append("<p><br />");
      ...
      sb.append("  您已成功申請加入的  ").append(admin.getStoreNm()).append(" 系統，您的試用期限：").append(sellsvo.getExpiredDt()).append("。<br />");
      sb.append("您的帳號：").append(loginvo.getLoginId()).append(" <br />");
      sb.append("您的密碼：").append(loginvo.getPasswd()).append("<br />");
      sb.append("您的商場：<a href='").append(sellsvo.getHomepage()).append("' target='_blank' >").append(sellsvo.getStoreNm()).append("</a></p>");
      ...
      errors.add(ActionErrors.GLOBAL_ERROR,new ActionError("join.Error","申請失敗："+e1.getMessage()));
      saveErrors(request,errors);
