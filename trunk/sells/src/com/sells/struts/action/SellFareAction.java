  ...
  public void setServlet(ActionServlet actionServlet) {
    ...
    try {
      ...
      if (sells == null ) {
        ...
        sells.setFreightFare(Integer.parseInt(StringUtils.defaultString(request.getParameter("freightFare"),"0")));
        sells.setFreightTp(StringUtils.defaultString(request.getParameter("freightTp"),"0"));
        sells.setProcess(Integer.parseInt(StringUtils.defaultString(request.getParameter("process"),"0")));
        sells.setLowAccount(Integer.parseInt(StringUtils.defaultString(request.getParameter("lowAccount"),"0")));
        sells.setNofreightFare(Integer.parseInt(StringUtils.defaultString(request.getParameter("nofreightFare"),"0")));
        sells.setNofreightQty(Integer.parseInt(StringUtils.defaultString(request.getParameter("nofreightQty"),"0")));
