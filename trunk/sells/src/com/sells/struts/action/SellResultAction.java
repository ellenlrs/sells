 ...
 * @struts.action-forward name="success" path="/sellResult.jsp"
 */
public class SellResultAction extends Action {
  private SellsService sellsService;
  private Log log = LogFactory.getLog(SellResultAction.class);
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      if (sells == null) {
        ...
        LoginData login = sellsService.findLoginDataBySellsNo(StringUtils
            .defaultString(request.getParameter("sellsNo")));
        if (sellsvo == null) {
      ...
      log.info("SellResut e:" + e.toString());
      errors.add("errMsg", new ActionError("alert.Error", "查詢失敗!"
          + e.getMessage()));
      saveErrors(request, errors);
