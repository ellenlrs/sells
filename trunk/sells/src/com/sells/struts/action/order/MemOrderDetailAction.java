 ...
 */
public class MemOrderDetailAction extends Action {
  private SellsService sellsService;
  private Log log = LogFactory.getLog(MemOrderDetailAction.class);
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      if (sellsNo.equals("")
          ...
          // 2.查詢訂單明細
          Orders vo = sellsService.getOrdersById(StringUtils
              .defaultString(request.getParameter("orderNo")), sells
              .getSellsNo(), memNo);
          if (vo != null && StringUtils.isNotBlank(vo.getOrderNo())) {
            Collection items = sellsService.findOrdersItemById(StringUtils
                .defaultString(request.getParameter("orderNo")));
