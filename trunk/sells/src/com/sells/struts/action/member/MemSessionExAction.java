 ...
 * @struts.action-forward name="success" path="/member/sessionLost.jsp"
 */
public class MemSessionExAction extends Action {
  private SellsService sellsService ;
  private Log log = LogFactory.getLog(MemSessionExAction.class);
