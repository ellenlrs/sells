 ...
 * @struts.action-forward name="successInfo" path="/member/infoC.jsp"
 * @struts.action-forward name="successPwd" path="/member/pwdMember.jsp"
 */
public class InfoMemberAction extends Action {
  private SellsService sellsService;
  private MemberService memberService;
  private Log log = LogFactory.getLog(InfoMemberAction.class);
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
    ...
    try {
      ...
      log.info("getSellsId:" + session.getId() + ",getSellsNO:" + sellsNo
          + ",getMemNo:" + memNo);
      ...
      if (sellsNo.equals("") || memNo.equals("")) { // 找不到Cookies
        ...
        // 2.查詢會員
        Member mem = memberService.getMember(sells.getSellsNo(), memNo);
