 ...
 */
public class ContactSellsInputAction extends Action {
  private SellsService sellsService ;
  private Log log = LogFactory.getLog(ContactSellsInputAction.class);
  ...
  public void setServlet(ActionServlet actionServlet) {
    ...
    try {
      ...
      request.setAttribute("subject", StringUtils.defaultString(request.getParameter("subject")));
