...
//      oProperties_.setProperty("mail.transport.protocol", "smtp"); 
//      oProperties_.setProperty("mail.host", mailserver); 
//      oProperties_.put("mail.smtp.auth", "true"); 
//      oProperties_.put("mail.smtp.port", "465"); 
//      oProperties_.put("mail.smtp.socketFactory.port", "465"); 
//      oProperties_.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory"); 
//      oProperties_.put("mail.smtp.socketFactory.fallback", "false"); 
//      oProperties_.setProperty("mail.smtp.quitwait", "false"); 
//      oSession_ = Session.getDefaultInstance(oProperties_, 
//          new javax.mail.Authenticator() { 
//            protected PasswordAuthentication getPasswordAuthentication() { 
//              return new PasswordAuthentication("jinwei.lin@gmail.com", "sp8560690120"); 
//            } 
//          });
//      mMessage_ = new MimeMessage(oSession_);
...
//  }
   ...
   * @throws MailException
   */
  public Mail2(MailBean mailBean) throws MailException {
    Security.addProvider(new com.sun.net.ssl.internal.ssl.Provider()); 
  ...
  public void run() {
    try {
      oSession_ = Session.getDefaultInstance(oProperties_, 
          new javax.mail.Authenticator() { 
            protected PasswordAuthentication getPasswordAuthentication() { 
              return new PasswordAuthentication("icarttw@gmail.com", "sp856069"); 
            } 
          });
      mMessage_ = new MimeMessage(oSession_);
      setTo();
