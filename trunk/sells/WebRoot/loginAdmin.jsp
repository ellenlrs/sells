...
<body topmargin="0" onLoad="document.form2.loginId.focus();">
...
<br>
<form name="form2" method="post" action="login.do" onSubmit="return checkForm(this);">
  <table width="329" border="0" align="center" cellpadding="6" cellspacing="0" bgcolor="#CCCCCC">
    <tr>
      <td bgcolor="#FFFFFF" align="center" colspan="2"><b class="style5">商家登入</b></td>
    </tr>
    <tr>
      <td width="100" bgcolor="#FFFFFF" align="center"><b class="style5">帳 號</b></td>
      <td width="205" bgcolor="#FFFFFF"><input name="loginId" type="text" ></td>
    </tr>
    <tr>
      <td width="100" bgcolor="#FFFFFF" align="center"><b class="style5">密   
        碼</b></td>
      <td bgcolor="#FFFFFF"><input name="passwd" type="password"></td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF" align="center" colspan="2"><input name="loginTp" type="hidden" value="A" >
      <input name="submit" type="submit" value="完成">
          <input name="submit22" type="reset" value="重填"></td>
    </tr>
  </table>
  </form></td>
      </tr>
