...
<body topmargin="0">
<%@ include file="chkSession.jsp"%><%@ include file="top1.jsp"%><form action='memberQuery2.do' name=search method=post>
<table width="615" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td ><table width="600" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
          <tbody>
            <tr>
              <td colspan="4" align="left" class="style5">匯出電子報</td>
            </tr>
            <tr>
              <td align="left" class="style5">分隔符號</td>
              <td colspan="3" align="left" class="style5"><select name="sp">
            ...
            <tr>
              ...
              <td align="left" class="style5"><input name="field" type="checkbox" id="field1" value="email" disabled checked>
                ...
                <label for="field6" style="cursor:hand;cursor: pointer;">生日 </label>
                <label for="field6" style="cursor:hand;cursor: pointer;"></label></td>
			...
			<tr>
              ...
              <td colspan="2" align="left" class="style5"><span class="style3">總筆數：${count}</span><br>
