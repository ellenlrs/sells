...
<table width="600" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
          <tbody>
            <tr>
			  <td align="center" bgcolor="#CCCCCC"><b class="t1 style3">檢視購物車連結</b> </td>
          ...
          <table width="600" border="0" align="center" cellpadding="10" cellspacing="1" bgcolor="#CCCCCC">
                <tbody>
                  <tr>
                    <td colspan="3" bgcolor="#ffffff" width="740"><form method="post" name="cart" action="carCode5.do#code" onSubmit="return check(this);" >
                      <span class="style5">1：顯示方式(可選文字連結或圖片連結)</span><br />
                          ...
                          ${carImg == 'userImg' ?'checked':''}>                                  </td>
                                ...
                                <tr>
                                  <td align="center"><input type="radio" id="Radio1" value="images/c01.gif" name="carImg" ${carImg == 'images/c01.gif' ?'checked':''}
                        ></td>
                                  <td ><label for="Radio1" style="cursor:hand;cursor: pointer;"><img src="images/c01.gif" /></label></td>
                                  <td><input type="radio" id="Radio2" value="images/c02.gif" name="carImg" ${carImg == 'images/c02.gif' ?'checked':''}></td>
                                  <td ><label for="Radio2" style="cursor:hand;cursor: pointer;"><img src="images/c02.gif" /></label></td>
                                  <td><input type="radio" id="Radio3" value="images/c03.gif" name="carImg" ${carImg == 'images/c03.gif' ?'checked':''}></td>
                                  <td ><label for="Radio3" style="cursor:hand;cursor: pointer;"><img src="images/c03.gif" /></label></td>
                                </tr>
                                <tr>
                                  <td><input type="radio" id="Radio4" value="images/c04.gif" name="carImg" ${carImg == 'images/c04.gif' ?'checked':''}></td>
                                  <td><label for="Radio4" style="cursor:hand;cursor: pointer;"><img src="images/c04.gif" /></label></td>
                                  <td><input type="radio" id="Radio5" value="images/c05.gif" name="carImg" ${carImg == 'images/c05.gif' ?'checked':''}></td>
                                  <td><label for="Radio5" style="cursor:hand;cursor: pointer;"><img src="images/c05.gif" /></label></td>
                                </tr>
                              </table>
