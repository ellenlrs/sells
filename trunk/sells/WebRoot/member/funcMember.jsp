...
<body><center><table width="670" border="0" align="center" cellspacing="1" class="tb1">
  <tr class="tb2">
...
<tr>
    <td width="100%" bgcolor="#FFFFFF"><%@ include file="menuMember.jsp"%>
        ...
        <tr class="tb2">
          <td height="28" align="center" bgcolor="#FFFFFF">歡迎光臨，會員服務專區</td>
          </tr>
		<tr>
          <td height="28" align="center" bgcolor="#FFFFFF">
  <input name="b123" onClick="goHome();" value="返回賣場" type="button" class="button"></td>
        </tr>
      </table>	
