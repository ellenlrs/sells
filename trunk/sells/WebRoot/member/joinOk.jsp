...
<table width="670" border="0" align="center" cellspacing="1" class="tb1">
        <tr class="tb2">
          <td height="28" align="center" bgcolor="#FFFFFF">加入會員成功</td>
    </tr>
		<tr>
          <td height="28" colspan=3 align="center" bgcolor=#FFFFFF>
            <input name="b123" onClick="goHome();" value="返回賣場" type="button" class="button">
            <INPUT name="b1212" type=button onClick="location.href='funcMember.do?sells=${requestScope.sells.sellsNo}&func=LOGIN'" value="會員登入" class="button">
          </td>
		</tr>
  </table>
