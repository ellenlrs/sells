...
<input type=hidden name='price' value='${item.price}'>${item.itemNo}</td>
        ...
        <tr>
          <th height="28" colspan=6 class="tb2">您共買了 ${totQty} 個商品 </td>
        </tr>
        <tr>
        ...
        <tr>
          <th height="28" colspan=6 class="tb2">購物總金額為︰${total + requestScope._toIcfare+requestScope._toOtfare}元 (含運費)</th>
        </tr>
		</c:if>
